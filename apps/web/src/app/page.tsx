...
import { ClientsSection } from './(pages)/_components/sections/ClientsSection'
import { ContactSection } from './(pages)/_components/sections/ContactSection'
import { HeroSection } from './(pages)/_components/sections/HeroSection'
import { ListOfJobsSection } from './(pages)/_components/sections/ListOfJobsSections'
import { ServicesSection } from './(pages)/_components/sections/ServicesSection'
